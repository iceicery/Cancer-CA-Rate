...
total1$popj<-total1$Lfmale ###Latino  <-
...
# Race pop
##############
total2$popjt<-total2$Tfmale ### non Group need this  <-
total2$popj<-total2$Lfmale  ###pop of group2         <-
...
CI1<-dsrTest(total1$value, total1$popj, total1$popjs, method = "gamma"  , mult = 1e5)
CI2<-dsrTest(total2$value, total2$popj, total2$popjs, method = "gamma"  , mult = 1e5)
CI1
CI2
